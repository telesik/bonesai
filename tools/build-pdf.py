...
| Открытые руки | Contack (Parker Brothers, 1939) — треугольные фишки, руки лицом вверх | На стандартном наборе домино аналог не найден. Асимметрия первого хода (игрок-A раскрывается до хода, игрок-B после) не встречается |
