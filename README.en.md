...
- **[RULES.ru.md](RULES.ru.md)** — the same rules in Russian. **The Russian text is the primary
  version**; if the two ever disagree, the Russian one is correct.
...
adapt them freely, with attribution.
