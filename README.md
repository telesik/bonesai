...
Игру придумал **Алексей Киселёв** для своей жены **Олечки** вечером 31 июля 2026 года. Замысел —
убрать из домино чрезмерную зависимость от случая, но не убирать случайность совсем: отсюда
открытые руки и закрытый базар как единственный её источник.

Правило постановки дубля прямо предложила Олечка — в первом варианте дубль всегда закрывал ветку.
Подробнее — [RULES.md §14](RULES.md).
