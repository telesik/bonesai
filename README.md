...
Игру придумал **Алексей Киселёв** — из желания заменить надоевшие домашние игры чем-то новым на том
же наборе костей. Ему принадлежат базовая механика и ключевые решения: рост дерева от корня,
ветвление, открытые руки, закрытие веток, подсчёт очков.
...
Правила игры вдвоём завершены и обкатаны вживую — за домашним столом сыграно много партий.
